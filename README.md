...
- <a>Felipe Gomes Rodrigues dos Santos</a>
- <a>Stefano Matiotta Tinelli</a> 
- <a>Alan Schiper</a> 
- <a>Beny Frid</a>
- <a>Mateus Neves</a> 
...
Para replicação (reexecução dos códigos):
1 - Copie este Git Hub para a sua maquina
2 - Preesione o botão `Open in Colab`, disponível na página do arquivo neste repositório do Github.
3 - Abra a função `Executar` e clique em `Executar Tudo`
...
HENRY, Zander. Salesforce Porter Five Forces Analysis - case48, 2018. Disponível em: <Salesforce Porter Five Forces Analysis (case48.com)>. Acesso em: 10 de agosto de 2022.
...
TCHILIAN, F.: Modelo Preditivo: o que é, para que serve e como aplicá-lo? - ClearSale, 2022. Disponível em: <https://blogbr.clear.sale/modelo-preditivo-saiba-como-aplica-lo#:~:text=Um%20modelo%20preditivo%20%C3%A9%2C%20de,matem%C3%A1tica%2C%20com%20probabilidade%20e%20estat%C3%ADstica.>. Acesso em: 08 de setembro de 2022.
...
SANTOS, T. M.; DEL VECHIO, G. H. A Gestão De Relacionamento com Clientes (CRM) Como Um Importante Recurso Para O Crescimento Empresarial. Revista Interface Tecnológica, [S. l.], v. 17, n. 1, p. 819–828, 2020.
...
BARBOSA, F. R. M.:  Otimizacao De Hiperparâmetros Em Algoritmos De ˆ Árvore De Decisão Utilizando Computação Evolutiva - Universidade Federal Do Tocantins, Campus Universitário De Palmas, Curso De Ciências Da Computação, 2018.
